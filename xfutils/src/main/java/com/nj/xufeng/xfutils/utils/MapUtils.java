...
public class MapUtils {
    ...
    /**
     * key取值    key1.key2.key3[0].key4
     * @param data
     * @param key
     * @return
     */
    public static Object getVal(Map<String,Object> data,String key){
        ...
        for (String k : keys) {
            if(k.contains("[")&&k.contains("]")){
                ...
                int location = Integer.parseInt(k.substring(k.indexOf("[")+1,k.indexOf("]")));
                result = ((Map<String,Object>)result).get(listKey);
                result = ((List<Map<String,Object>>)result).get(location);
            }else{
                result = ((Map<String,Object>)result).get(k);
            }
        }
        return result;
    }
     ...
     * @param newMap
     */
    public static void replace( Map oldMap,Map newMap){
        if(null==oldMap){
            oldMap = new HashMap();
        }
    ...
    public static List<String> getList(List<Map<String,Object>> listmap,String key){
    ...
    public static List<Map<String,Object>> ConvertObjToListMap(List list) {
        List<Map<String,Object>> mapList = new ArrayList<>();
        for (Object obj:list) {
            mapList.add(ConvertObjToMap(obj));
        }
        return mapList;
    }
