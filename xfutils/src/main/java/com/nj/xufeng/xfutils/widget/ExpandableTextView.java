...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    public void setOnCollapsedChangeListener(CollapsedChangeListener collapsedChangeListener){
...
//            	  if(null!=collapsedChangeListener){
//                  	collapsedChangeListener.onCollapsedBefore(mCollapsed);
//                  }
...
//                LogUtils.d("mCollapsedHeight"+mCollapsedHeight);
                if(null!=collapsedChangeListener){
                	collapsedChangeListener.onCollapsedAfter(mCollapsed,beforeHeight);
                }
            }
            @Override
    ...
    public interface CollapsedChangeListener{
    	...
    	public void onCollapsedBefore(boolean collapsed);
    	
    	public void onCollapsedAfter(boolean collapsed, int beforeHeight);
