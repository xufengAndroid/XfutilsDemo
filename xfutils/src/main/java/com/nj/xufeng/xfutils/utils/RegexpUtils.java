...
public final class RegexpUtils {
	...
	public static final String QQ_REGEXP = "^[1-9][0-9]{5,9}$";
	 ...
	 * 
	 */
	public static final String EMAIL_REGEXP = "^\\w+@\\w+\\.[a-z]+(\\.[a-z]+)?$";
	 ...
	 * 请设置6-16位字母与数字组合的密码
	 */
	public static final String PASSWORD_REGEXP = "^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,16}$";
     ...
     */ 
	public static final String PHONE_NO_REGEXP = "^(\\+\\d+)?1[3458]\\d{9}$";
	 ...
	 * 匹配字符为中英文数字
	 */
	public static final String CHAR_LEGAL_REGEXP="^[\\u4e00-\\u9fa5\\x00-\\xffa-zA-z]+$";
